...
class Application(tornado.web.Application):
    def __init__(self):
        ...
        handlers = [(r"/[/]?", BaseHandler),
                    ...
                    (r"/Delete[/]?",        skh.ResetDatabase),
                    (r"/Register[/]?",        skh.RegisterNewCLient),
                    (r"/SignIn[/]?",            skh.SignIn),
                    (r"/UpdateInfo[/]?",      skh.UpdateClientInfo),
                    (r"/PredictOne[/]?",      skh.PredictOneFromDatasetId), 
                    (r"/ws[/]?", skh.WSHandler)  # this class handlers the Client server web socket connection
                    ]
